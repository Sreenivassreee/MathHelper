...
class Additions {
  ...
  static MasterQuestion abc() {
    ...
    var question = "${list[0]} - ${list[1]} - ${list[2]}";
    ...
    // }
    var inAnswer1 = random.nextInt(150) + answer + 5;
    var inAnswer2 = random.nextInt(30) + answer;
    var inAnswer3 = random.nextInt(150) + answer + 10;
